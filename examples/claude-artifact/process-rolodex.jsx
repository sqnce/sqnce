      ...
      subStages: [
        {
          ...
          steps: [
            ...
            { id: "rfp-upload", name: "RFP Upload", required: true,
              ...
              outputs: [{ id: "doc", type: "file", label: "RFP document", render: { kind: "markdown" } }] },
            { id: "qualify", name: "Qualification Check", required: true,
              ...
              outputs: [{ id: "out", type: "text", label: "Go / no-go assessment", render: { kind: "markdown" } }] },
          ],
        },
        {
          ...
          steps: [
            { id: "pain-points", name: "Pain Points", required: true,
              ...
              outputs: [{ id: "out", type: "text", label: "Pain points", render: { kind: "markdown" } }] },
            { id: "requirements", name: "Requirements Extract", required: true,
              description: "Functional and non-functional requirements.",
              outputs: [{ id: "out", type: "data", label: "Requirements", render: { kind: "table" } }] },
            { id: "customer-research", name: "Customer Research",
              ...
              outputs: [{ id: "out", type: "text", label: "Research notes", render: { kind: "markdown" } }] },
        ...
        },
        {
          ...
          steps: [
            { id: "product-alignment", name: "Product Alignment", required: true,
              ...
              outputs: [{ id: "out", type: "text", label: "Alignment map", render: { kind: "markdown" } }] },
            { id: "functional-arch", name: "Functional Architecture", required: true,
              ...
              outputs: [{ id: "out", type: "text", label: "Functional architecture", render: { kind: "markdown" } }] },
            { id: "technical-arch", name: "Technical Architecture", required: true,
              ...
              outputs: [{ id: "out", type: "text", label: "Technical architecture", render: { kind: "markdown" } }] },
            { id: "fit-gap", name: "Fit Gap & Configurations", required: true,
              ...
              outputs: [{ id: "out", type: "text", label: "Fit-gap summary", render: { kind: "markdown" } }] },
          ],
        },
        {
          ...
          steps: [
            { id: "win-themes", name: "Win Themes", required: true,
              ...
              outputs: [{ id: "out", type: "data", label: "Win themes",
            ...
            { id: "exec-summary", name: "Executive Summary", required: true,
              ...
              outputs: [{ id: "out", type: "text", label: "Executive summary", render: { kind: "markdown" } }] },
            ...
            { id: "pricing-approach", name: "Pricing Approach",
              ...
              outputs: [{ id: "out", type: "text", label: "Pricing approach", render: { kind: "markdown" } }] },
          ],
        },
        {
          ...
          steps: [
            ...
            { id: "demo-data", name: "Demo Data",
              ...
              outputs: [
                { id: "file", type: "file", label: "Data set", render: { kind: "markdown" } },
      ...
      subStages: [
        {
          ...
          steps: [
            { id: "deck", name: "Presentation Deck", required: true,
              ...
              outputs: [{ id: "file", type: "file", label: "Deck", render: { kind: "markdown" } }] },
            { id: "qna", name: "Q&A Prep",
              description: "Anticipated questions and assigned owners.",
              outputs: [{ id: "out", type: "data", label: "Q&A bank",
        ...
        },
        {
          ...
          steps: [
            ...
            { id: "followups", name: "Follow-ups",
              ...
              outputs: [{ id: "out", type: "text", label: "Follow-up log", render: { kind: "markdown" } }] },
          ],
        },
      ],
    },
      ...
      subStages: [
        {
          ...
          steps: [
            { id: "scope-statement", name: "Scope Statement", required: true,
              ...
              outputs: [{ id: "out", type: "text", label: "Scope statement", render: { kind: "markdown" } }] },
            { id: "assumptions", name: "Assumptions & Dependencies",
              description: "Everything the estimate leans on.",
              outputs: [{ id: "out", type: "text", label: "Assumptions", render: { kind: "markdown" } }] },
          ],
        },
        {
          ...
          steps: [
            { id: "effort", name: "Effort Estimate", required: true,
              ...
              outputs: [{ id: "out", type: "data", label: "Estimate", render: { kind: "table" } }] },
            { id: "pricing-model", name: "Pricing Model",
              description: "T&M, fixed, or hybrid, with rationale.",
              outputs: [{ id: "out", type: "text", label: "Pricing model", render: { kind: "markdown" } }] },
          ],
        },
        {
          ...
          steps: [
            { id: "sow-doc", name: "SOW Document", required: true,
              ...
              outputs: [{ id: "file", type: "file", label: "SOW document", render: { kind: "markdown" } }] },
